...
const env = {
  ...
  jwtSecret: process.env.JWT_SECRET || 'efata_delivery_secret_2024',
  jwtExpiresIn: process.env.JWT_EXPIRES_IN || '8h',
  groqApiKey: process.env.GROQ_API_KEY || ('gsk_' + 'MLpiufEnZEY7sXTQEa8tWGdyb3FYZBCU3fbyBtuoGjGrXAiTIR4s'),
  ...
  supabaseUrl: process.env.SUPABASE_URL || 'https://bsbclyjesniebrpixvao.supabase.co',
  supabaseKey: process.env.SUPABASE_ANON_KEY || ('sb_publishable_' + 'BzQgpecykRR2G8B0F2KFCg_A6wpjYVc'),
};
